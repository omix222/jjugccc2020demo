c# MicroProfile generated Application
...
This will create an executable jar file **jjugdemo-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/jjugdemo-microbundle.jar --port 8180
